<template>
  <div id="layout">
    ...
    <h4 class="hf">商品详情</h4>
    <b-card no-body class="overflow-hidden cardxq">
      <b-row no-gutters>
        <b-col md="3">
          <b-card-img :src="src" class="rounded-0"></b-card-img>
        </b-col>
        <b-col md="9">
          <b-card-body :title="form.t_name">
            <b-card-text>
              {{form.t_info}}
            </b-card-text>
            ...
            <b-button href="http://192.168.1.105:8081/#/womenclothXQ" variant="primary">立即购买</b-button>
          </b-card-body>
        </b-col>
      </b-row>
    </b-card>
    <div class="middlepic wow fadeInDown"><img src="http://192.168.1.105:8080/Z_web/pic/WA/女装-3l.png" class="img">
    </div>
  </div>
</template>
<script>
...
.btn[data-v-2598717a]:not(:disabled):not(.disabled) {
  cursor: pointer;
  /* width: 98%; */
  float: right;
...
.card-img[data-v-2598717a],
.card-img-top[data-v-2598717a] {
  border-top-left-radius: calc(0.25rem - 1px);
  border-top-right-radius: calc(0.25rem - 1px);
  height: 240px;
}
