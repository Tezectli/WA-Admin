<template>
  <el-dialog title="about修改" :visible.sync="dialog_Info_flag" width="580px" @close="close" @opened="openDialog">
    <el-form :model="form" ref="addInfoForm">
      ...
      <el-form-item label="顶部时间" :label-width="formLabelWidth">
...
export default {
  ...
  setup(props, { emit, root }) {
    ...
    const getInfo = () => {
      ...
      Aboutuslist(requestData).then(response => {
        console.log(response.data);
        console.log("用户2222");
        let responseData = response.data.list[0];
        form.t_name = responseData.SPPIC;
        form.t_nandu = responseData.SPTIME;
